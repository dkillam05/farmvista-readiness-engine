...
// PURPOSE:
// Surface wetness logic from original FarmVista model
// ============================================
...
// --------------------------------------------
// ORIGINAL SURFACE TUNING
// --------------------------------------------
const TUNE = {
  SURFACE_CAP_IN: 0.70,
  SURFACE_RAIN_CAPTURE: 2.2,
  SURFACE_PENALTY_MAX: 55,
  SURFACE_PENALTY_EXP: 0.9,

  SURFACE_DRY_BASE: 0.02,
  SURFACE_DRY_DRYPWR_W: 0.28,
  SURFACE_DRY_ET0_W: 0.18,
  SURFACE_DRY_WIND_W: 0.08,
  SURFACE_DRY_SUN_W: 0.08,
  SURFACE_DRY_VPD_W: 0.08,
  ...
  SURFACE_WET_HOLD_MAX_REDUCTION: 0.75,
...
function surfaceStorageAddFromRain(rainIn) {
  ...
  return clamp(
    rain * TUNE.SURFACE_RAIN_CAPTURE,
    0,
    TUNE.SURFACE_CAP_IN
  );
}
...
function surfaceWetHoldDryMult(surfaceStorage) {
  ...
  const wetFrac = clamp(
    (frac - start) / Math.max(1e-6, 1 - start),
    0,
    1
  );
